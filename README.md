...
_Spring Security sitio protegido con credenciales donde se valida el ingreso con diferentes roles administradores y clientes, filtros de seguridad para el request_
...
Por favor lee el [CONTRIBUTING.md](https://github.com/adrianfrancof/SitioProtegidoConCredenciales.git) para detalles de código de conducta, y el proceso para enviar pull requests.
